...
public class Collection extends BaseEntity {
    ...
    @Field(name = "tr_no", targetType = FieldType.STRING)
    private String trNo;//tr

    @Field(name = "upi_id", targetType = FieldType.STRING)
    private String upiId;//upi id

    @Field(name = "utr", targetType = FieldType.STRING)
    ...
    @Field(name = "fee", targetType = FieldType.DOUBLE)
    ...
    @Field(name = "settle_cycle", targetType = FieldType.STRING)
    private String settleCycle;//结算周期;参考-PayInSettleCycleEnum

    @Field(name = "settle_status", targetType = FieldType.STRING)
    ...
    @Field(name = "upi_url", targetType = FieldType.STRING)
    private String upiUrl;//

    @Field(name = "notify_url", targetType = FieldType.STRING)
    private String notifyUrl;//回调地址

    @Field(name = "return_url", targetType = FieldType.STRING)
    ...
    @Field(name = "call_time", targetType = FieldType.INT64)
    @JsonFormat(pattern = "yyyy-mm-dd hh:mm:ss")
    ...
    @Field(name = "superior_setlle_status", targetType = FieldType.STRING)

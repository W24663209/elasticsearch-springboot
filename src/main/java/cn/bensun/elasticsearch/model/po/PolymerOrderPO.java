 ...
 * @CreateTime 2022/12/31 19:47:14
 */
@Data
@Document(indexName = "t_polymer_order",type = "_doc")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class PolymerOrderPO implements Serializable {
    ...
    @Field(name = "detail_message", value = "detail_message")
    ...
    @Field(name = "stack_trace", value = "stack_trace")

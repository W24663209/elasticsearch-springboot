 ...
 * @CreateTime 2022/12/31 19:47:10
 */
@Data
@Document(indexName = "t_polymer_instead_order")
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class PolymerInsteadOrderPO implements Serializable {
    ...
    @Field(name = "deduct_state", value = "deduct_state")
    private Integer deductState;//扣除商家余额状态，0：未扣除，1：已扣除，2：已回滚
    ...
    @Field(name = "fail_message", value = "fail_message")
